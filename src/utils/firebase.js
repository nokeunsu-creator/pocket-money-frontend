...
import { getDatabase, ref, set, onValue, remove, get, push, update, runTransaction } from 'firebase/database'
...
export { db, ref, set, onValue, remove, get, push, update, runTransaction }
